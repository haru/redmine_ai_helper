...
| S021 | specs/045-fix-autocompletion-request-pileup (research.md + plan.md) | feature-artifact | 2026-08-20 | 2026-08-20 | completion-request-timeout-policy.md, inline-completion-request-flow.md, js-test-convention.md, issue-ai-features.md, llm-provider-layer.md, base-agent-llm-calls.md |
