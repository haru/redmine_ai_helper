...
RedmineApp::Application.routes.draw do
  ...
  post "ai_helper/issue/:id/suggest_completion", to: "ai_helper#suggest_completion", as: "ai_helper_suggest_completion", constraints: { id: /\d+|new/ }
  post "ai_helper/wiki/:project_id/suggest_completion", to: "ai_helper#suggest_wiki_completion", as: "ai_helper_suggest_wiki_completion"
  post "ai_helper/wiki/:project_id/:page_name/suggest_completion", to: "ai_helper#suggest_wiki_completion", as: "ai_helper_suggest_wiki_completion_with_page"
