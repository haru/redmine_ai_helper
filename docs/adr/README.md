...
| [022](./022-teams-inbound-adapter-design.md) | Microsoft Teams inbound adapter design | Accepted (premise amended by ADR-023) |
| [023](./023-teams-single-tenant-bot.md) | Teams integration targets single-tenant bots (amends the premise of ADR-022) | Accepted |
