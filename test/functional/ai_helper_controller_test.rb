  ...
  context "AiHelperController" do
    ...
    context "#health_report_show" do
      ...
      should "display health report detail" do
        ...
        assert_response :success
        assert_template partial: "ai_helper/project/_health_report_show"
        assert_not_nil assigns(:health_report)
      ...
      should "return 403 when user does not have permission" do
        # Switch to non-admin user without permission
        non_member_user = User.find(4) # User that's not a member of the project
    ...
    context "#health_report_destroy" do
      ...
      should "delete own report" do
        # User already has view_ai_helper permission from setup
      ...
      should "not delete other user's report without permission" do
        ...
        # Add delete permission but user is not owner and not admin
        role = Role.find(1)
